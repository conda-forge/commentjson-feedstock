...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/commentjson-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12701&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/commentjson-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `commentjson` can be installed with:

```
conda install commentjson
```

It is possible to list all of the versions of `commentjson` available on your platform with:
